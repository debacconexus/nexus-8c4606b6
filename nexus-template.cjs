...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Cancer Prediction Failure Registry";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Failure Event";
process.env.TABLE_NAME = process.env.TABLE_NAME || "failure_event_records";
'use strict';
